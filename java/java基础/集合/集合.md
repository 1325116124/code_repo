...
public class CollectionTest {
    ...
    public void test(){
        ...
        coll.add(false);
        //contains(Object 0):判断当前集合中是否包含obj
    ...
    public void test2(){
        ...
        coll.remove(123);
        System.out.println(coll);
        coll.remove(new Person("Jerry",30));
        System.out.println(coll);
...
//        System.out.println(coll);
        ...
        coll1.add(false);
        //6.equals(Object obj):要想返回true，需要当前集合和形参集合的元素都相同，由于是ArrayList，还必须顺序一致，否则为false
...
### 区分remove(index) 和 remove(Object)的区别
